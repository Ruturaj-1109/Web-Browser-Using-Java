...
c2w_webEngine.setPromptHandler( promptData ->SimpleDialogs.prompt(promptData.getMessage(),"Query from web page",promptData.getDefaultValue()));
...
open.setOnAction( e -> {
String url = SimpleDialogs.prompt("Enter the URL of the page that you want to open.","Get URL");
...
// Add a "Close All" command only if this is not the onlywindow.
