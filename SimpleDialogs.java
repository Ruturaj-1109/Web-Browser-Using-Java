...
// The idea is to consume a button click on the OK button if thestate of
...
dialog.getDialogPane().getButtonTypes().addAll(ButtonType.CANCEL, ButtonType.NO, ButtonType.YES);
Optional<ButtonType> result = dialog.showAndWait();
...
private Slider hueSlider, brightnessSlider, saturationSlider, redSlider, greenSlider, blueSlider;//Sliders to control color components.
private Label hueLabel, brightnessLabel, saturationLabel, redLabel, greenLabel, blueLabel;// For displaying color component values.
...
String colorString = String.format("#%02x%02x%02x",(int)(255*color.getRed()),(int)(255*color.getGreen()),(int)(255*color.getBlue()) );
...
brightnessLabel.setText(String.format(" Brightness = %1.3f",color.getBrightness()));redLabel.setText(String.format(" Red = %1.3f",color.getRed()));
